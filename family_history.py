...
def print_death_age(people_dict):
    ...
    Return: nothing
    """
    for person_key, persons_list in people_dict.items():
        name = persons_list[NAME_INDEX]
        birth = persons_list[BIRTH_YEAR_INDEX]
        death = persons_list[DEATH_YEAR_INDEX]
        age = death - birth
        print(f'{name} {age} ')
...
def print_marriages(marriages_dict, people_dict):
    ...
    """
        ...
        # this is to get the information of the husband's name
        # wife's name, their wedding year.
    for marrige_key, marriage_list in marriages_dict.items():
        husbands_name=marriage_list[HUSBAND_KEY_INDEX]
        wifes_name=marriage_list[WIFE_KEY_INDEX]
        wedd_year=marriage_list[WEDDING_YEAR_INDEX]

        #this is to get information and calculate for their ages at wedding
        husband_birth=people_dict[BIRTH_YEAR_INDEX]
        hus_marriage=marriage_list[WEDDING_YEAR_INDEX]
        hus_age_wedding=hus_marriage - husband_birth
        
        wife_birth=people_dict[BIRTH_YEAR_INDEX]
        wife_marriage=marriage_list[WEDDING_YEAR_INDEX]
        wife_age_wedding= wife_marriage - wife_birth

        print(f'{husbands_name} {hus_age_wedding} {wedd_year} {wifes_name} {wife_age_wedding}')
